            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <form method="post" action="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" 
                                           ...
                                           class="regular-text" 
                                           required 
                                           placeholder="<?php esc_attresc_html_e('e.g., Blog Post - How To Guide', 'ai-content-classifier'); ?>" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="template_prompt" 
                                              ...
                                              class="large-text" 
                                              required
                                              placeholder="<?php esc_attresc_html_e('Write a comprehensive guide about [TOPIC]. Include step-by-step instructions, tips, and examples. Target audience: [AUDIENCE]. Tone: [TONE]. Length: [LENGTH] words.', 'ai-content-classifier'); ?>"></textarea>
                                    <p class="description">
                        ...
                        <p class="submit">
                            <input type="submit" class="button button-primary" value="<?php esc_attresc_html_e('Create Template', 'ai-content-classifier'); ?>">
                        </p>
                    </form>
                </div>
            </div>
                        ...
                        <div class="aicg-templates-list">
                            <?php foreach ($templates as $template): ?>
                                <div class="template-item">
                                    ...
                                    <p><strong><?php esc_html_e('SEO Enabled:', 'ai-content-classifier'); ?></strong> <?php echo esc_html($template)->seo_enabled ? esc_html__('Yes', 'ai-content-classifier') : esc_html__('No', 'ai-content-classifier'); ?></p>
                                    ...
                                    <div class="template-prompt">
                                        ...
                                        <?php if (str_word_count($template->prompt) > 50): ?>
                                            <button type="button" class="button button-small toggle-full-prompt" data-template-id="<?php echo esc_html($template)->id; ?>">
                                                <?php esc_html_e('Show Full Prompt', 'ai-content-classifier'); ?>
                                            </button>
                                        <?php endif; ?>
                                    </div>
                                    <div class="template-full-prompt" id="full-prompt-<?php echo esc_html($template)->id; ?>" style="display: none;">
                                    ...
                                    <div class="template-actions">
                                        ...
                                        <button type="button" class="button edit-template" data-template-id="<?php echo esc_html($template)->id; ?>">
                                            <?php esc_html_e('Edit', 'ai-content-classifier'); ?>
                                        </button>
                                        <form method="post" style="display: inline;" onsubmit="return confirm('<?php esc_attresc_html_e('Are you sure you want to delete this template?', 'ai-content-classifier'); ?>');">
                                            <input type="hidden" name="action" value="delete_template">
                                            <input type="hidden" name="template_id" value="<?php echo esc_html($template)->id; ?>">
                                            <input type="hidden" name="nonce" value="<?php echo esc_attr(wp_create_nonce('aicg_template_nonce')); ?>">
                                            <input type="submit" class="button button-link-delete" value="<?php esc_attresc_html_e('Delete', 'ai-content-classifier'); ?>">
                                        </form>
                                    </div>
                                </div>
                            <?php endforeach; ?>
